...
| 4   | Smoke tests: authenticated reads, a cleaned-up write, asset headers, PWA version, cron presence (24.5). **Partial (2026-09-21):** cd-dev [`35561028251`](https://github.com/sprmke/kame-homes/actions/runs/35561028251) — cron probe + partial listing smoke + transport compression; `verify:deployed-preview` incl. `/pwa-version.json`; adversarial **12/12**. Authenticated read/write still open. | CI + hosted         |

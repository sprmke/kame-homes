...
| 4   | Smoke tests: authenticated reads, a cleaned-up write, asset headers, PWA version, cron presence (24.5). **Partial (2026-09-21):** cd-dev [`35562534679`](https://github.com/sprmke/kame-homes/actions/runs/35562534679) — cron probe + partial listing smoke + transport compression; `verify:deployed-preview` incl. `/pwa-version.json`; adversarial **13/13**. Authenticated read/write still open. | CI + hosted         |
...
- `adversarialAuthLive.test.ts` — **13/13** on cd-dev run [`35562534679`](https://github.com/sprmke/kame-homes/actions/runs/35562534679) (2026-09-21).

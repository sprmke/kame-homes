...
| 4   | Smoke tests: authenticated reads, a cleaned-up write, asset headers, PWA version, cron presence (24.5). **Partial (2026-09-21):** cd-dev [`35567004695`](https://github.com/sprmke/kame-homes/actions/runs/35567004695) — cron probe + partial listing smoke + transport compression; `verify:deployed-preview` incl. `/pwa-version.json`; adversarial **14/14**. Authenticated read/write still open. | CI + hosted         |
...
- `adversarialAuthLive.test.ts` — **14/14** on cd-dev run [`35567004695`](https://github.com/sprmke/kame-homes/actions/runs/35567004695) (2026-09-21).

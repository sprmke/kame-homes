...
| 7   | Adversarial suite (21.6 table). **Partial:** `adversarialAuthLive.test.ts` (**6 cases**: authenticated/admin/super-admin/cron + malformed JWT) green on hosted dev and **cd-dev** run `35547228391` (2026-09-21); full role×endpoint matrix + Playwright still open.                | Tests + seed data |

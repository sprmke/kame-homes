...
| 3   | Doc 21 adversarial matrix executable and green. **Partial:** `adversarialAuthLive.test.ts` **13/13** on cd-dev [`35562534679`](https://github.com/sprmke/kame-homes/actions/runs/35562534679) (2026-09-21). Seeded matrix rows still open. | Doc 21 + tests           |

...
| 3   | Doc 21 adversarial matrix executable and green. **Partial:** `adversarialAuthLive.test.ts` **15** cases (hosted dev green 2026-09-21); last cd-dev **14/14** [`35567004695`](https://github.com/sprmke/kame-homes/actions/runs/35567004695). Seeded matrix rows still open. | Doc 21 + tests           |

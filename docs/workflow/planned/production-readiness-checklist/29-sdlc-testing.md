...
| 3   | Doc 21 adversarial matrix executable and green. **Partial:** `adversarialAuthLive.test.ts` **11/11** hosted dev (2026-09-21); cd-dev **8/8** on `35556921767` until next deploy. | Doc 21 + tests           |

...
| 3   | Doc 21 adversarial matrix executable and green. **Partial:** `adversarialAuthLive.test.ts` **14/14** on cd-dev [`35567004695`](https://github.com/sprmke/kame-homes/actions/runs/35567004695) (2026-09-21). Seeded matrix rows still open. | Doc 21 + tests           |

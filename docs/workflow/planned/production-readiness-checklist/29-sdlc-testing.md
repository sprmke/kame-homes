...
| 3   | Doc 21 adversarial matrix executable and green. **Partial:** `adversarialAuthLive.test.ts` **12/12** hosted dev (`2a4865c3`, 2026-09-21); cd-dev **11/11** on `35558455879` until run [`35561028251`](https://github.com/sprmke/kame-homes/actions/runs/35561028251) completes. | Doc 21 + tests           |

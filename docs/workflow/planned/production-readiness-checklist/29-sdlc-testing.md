...
| 3   | Doc 21 adversarial matrix executable and green. **Partial:** `adversarialAuthLive.test.ts` **8/8** hosted dev + cd-dev [`35556921767`](https://github.com/sprmke/kame-homes/actions/runs/35556921767) (2026-09-21). | Doc 21 + tests           |

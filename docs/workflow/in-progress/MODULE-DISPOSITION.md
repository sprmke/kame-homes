...
| **super-admin-step-up-otp**       | v1 **shipped** — 12 gated `serveSuperAdmin` mutations (includes `ai-platform-generation-overrides`) | Manual QA (4 checks)                                                                                                                          | **Moved to for-testing 2026-09-09** — QA batch #7                                                            |
| **marketing-ai-asset-generation** | Phases 1–3 **shipped** (`ci:quality` green 2026-09-14)                                              | Live Veo/Gemini calls accepted residual (funded key; same class as PayMongo in other shipped modules). Allowances unchanged pending burn data | **Done 2026-09-14** — [`../done/marketing-ai-asset-generation.md`](../done/marketing-ai-asset-generation.md) |

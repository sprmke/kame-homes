...
**Before non-trivial work**, read `docs/architecture/overview.md` (full-app picture) and `docs/PROJECT.md` (architecture/API/routes/env vars). For booking-status/email/calendar/sheet changes, also read `.cursor/rules/booking-workflow.mdc`. Those docs are authoritative, not just background reading (see "Docs are the source of truth" below).
...
| Change                                                                                             | Update                                                                                                                                                                                                                                                                                                                          |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Architecture, routes, env vars, API, data model                                                    | `docs/architecture/overview.md` (full-app picture) + `docs/PROJECT.md` (topic index / API / env)                                                                                                                                                                                                                                |
